...
const STATS = [
  { value: 2, suffix: "+", label: "Years of Experience", desc: "Building production-ready web applications" },
  { value: 40, suffix: "+", label: "Projects Shipped", desc: "Across freelance, personal, and collaborative work" },
];
