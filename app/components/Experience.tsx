    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {/* Years of Experience */}
          <div
            className="text-center p-8 rounded-2xl bg-zinc-900/50 border border-yellow-600/20 backdrop-blur-sm transition-all duration-300 hover:transform hover:scale-105 cursor-pointer"
            data-aos="fade-up"
            data-aos-delay="100"
          >
