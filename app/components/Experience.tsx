...
const STATS = [
  { value: 2, suffix: "+", label: "Years of Experience", desc: "Building production-grade interfaces" },
  { value: 40, suffix: "+", label: "Projects Shipped", desc: "Across various industries" },
];
